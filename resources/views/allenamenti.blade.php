                ...
                <div id="trainings-display">
                    @foreach ($allenamenti as $a)
                        <ul class="trainings-display">
                            ...
                            <li class="training-detail">{{ $a->weeks }}</li>
                            <li class="training-detail">{{ $a->days }}</li>
                            <li class="training-detail">{{ $a->coach }}</li>
                            <li class="training-detail">{{ $a->start_date }}</li>
                            <li class="training-detail">{{ $a->finish_date }}</li>
                        </ul>
                    @endforeach
                </div>
